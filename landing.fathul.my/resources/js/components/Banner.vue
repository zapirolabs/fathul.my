<template>
  ...
  >
    <p class="font-extrabold text-base leading-[1.4] tracking-[0.01em] flex items-center gap-1">Program Jaminan Kerjaya<span class="opacity-60 font-extrabold ml-1">2025</span></p>
    <a href="/" class="inline-flex items-center justify-center rounded-full bg-white text-black font-extrabold px-3 text-[0.85rem] leading-[1.1] h-6">Daftar</a>
  </div>
</template>
