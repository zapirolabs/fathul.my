  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.collapsible === "none") {
        ...
        _push(ssrRenderComponent(unref(_sfc_main$Q), mergeProps({ open: unref(openMobile) }, _ctx.$attrs, { "onUpdate:open": unref(setOpenMobile) }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$O), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$M, { class: "sr-only" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    return [
                      createVNode(_sfc_main$M, { class: "sr-only" }, {
                        default: withCtx(() => [
                          createVNode(_sfc_main$L, null, {
                            default: withCtx(() => [
                              createTextVNode("Sidebar")
...
const _sfc_main$B = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!__props.tooltip) {
        _push(ssrRenderComponent(_sfc_main$C, mergeProps({ ...unref(delegatedProps), ..._ctx.$attrs }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            } else {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$D), { "as-child": "" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$C, { ...unref(delegatedProps), ..._ctx.$attrs }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    return [
                      createVNode(_sfc_main$C, { ...unref(delegatedProps), ..._ctx.$attrs }, {
                        default: withCtx(() => [
                          renderSlot(_ctx.$slots, "default")
                        ]),
                        _: 3
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (props.variant === "sidebar") {
        _push(ssrRenderComponent(unref(_sfc_main$H), mergeProps({ class: className.value }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            } else {
...
const _sfc_main$w = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$x, { class: "size-5 fill-current text-white dark:text-black" }, null, _parent));
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          if (index === __props.breadcrumbs.length - 1) {
                            ...
                            _push4(ssrRenderComponent(unref(_sfc_main$t), { "as-child": "" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                          ...
                          return [
                            index === __props.breadcrumbs.length - 1 ? (openBlock(), createBlock(unref(_sfc_main$r), { key: 0 }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(item.title), 1)
                              ]),
                              _: 2
                            }, 1024)) : (openBlock(), createBlock(unref(_sfc_main$t), {
                              key: 1,
                              "as-child": ""
                            }, {
                              default: withCtx(() => [
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.breadcrumbs, (item, index) => {
                      return openBlock(), createBlock(Fragment, { key: index }, [
                        ...
                        index !== __props.breadcrumbs.length - 1 ? (openBlock(), createBlock(unref(_sfc_main$q), { key: 0 })) : createCommentVNode("", true)
                      ], 64);
                    }), 128))
                  ];
                }
...
const _sfc_main$l = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(_sfc_main$o), { class: "h-8 w-8 overflow-hidden rounded-lg" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (showAvatar.value) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$n), { class: "rounded-lg text-black dark:text-white" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              showAvatar.value ? (openBlock(), createBlock(unref(_sfc_main$m), {
                key: 0,
                src: user.value.avatar,
                alt: user.value.name
              }, null, 8, ["src", "alt"])) : createCommentVNode("", true),
              createVNode(unref(_sfc_main$n), { class: "rounded-lg text-black dark:text-white" }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(getInitials2)(user.value.name)), 1)
                ]),
                _: 1
...
const _sfc_main$d = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(_sfc_main$g), { class: "p-0 font-normal" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$i), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$h), { "as-child": true }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode(unref(_sfc_main$h), { "as-child": true }, {
                default: withCtx(() => [
                  createVNode(unref(Link), {
                    class: "block w-full",
                    href: _ctx.route("profile.edit"),
      ...
      _push(ssrRenderComponent(unref(_sfc_main$f), null, null, _parent));
      _push(ssrRenderComponent(unref(_sfc_main$h), { "as-child": true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(ssrRenderComponent(unref(NavigationMenuRoot), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "default"),
              __props.viewport ? (openBlock(), createBlock(_sfc_main$c, { key: 0 })) : createCommentVNode("", true)
            ];
          }
        }),
        _: 3
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$Q), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$K), { "as-child": true }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$O), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$L), { class: "sr-only" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$M), { class: "flex justify-start text-left" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$x, { class: "size-6 fill-current text-black dark:text-white" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_sfc_main$x, { class: "size-6 fill-current text-black dark:text-white" })
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    createVNode(unref(_sfc_main$L), { class: "sr-only" }, {
                      default: withCtx(() => [
                        createTextVNode("Navigation Menu")
                      ]),
                      _: 1
                    }),
                    createVNode(unref(_sfc_main$M), { class: "flex justify-start text-left" }, {
                      default: withCtx(() => [
                        createVNode(_sfc_main$x, { class: "size-6 fill-current text-black dark:text-white" })
                      ]),
                      _: 1
            ...
            return [
              createVNode(unref(_sfc_main$K), { "as-child": true }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$z), {
                    variant: "ghost",
                    size: "icon",
      ...
      _push(ssrRenderComponent(unref(_sfc_main$b), { class: "ml-10 flex h-full items-stretch" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$9), { class: "flex h-full items-stretch space-x-2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
            ...
            return [
              createVNode(unref(_sfc_main$9), { class: "flex h-full items-stretch space-x-2" }, {
                default: withCtx(() => [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(mainNavItems), (item, index) => {
                    return openBlock(), createBlock(unref(_sfc_main$a), {
                      key: index,
      ...
      ssrRenderList(unref(rightNavItems), (item) => {
        _push(ssrRenderComponent(unref(_sfc_main$E), { "delay-duration": 0 }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$k), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$e), { "as-child": true }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$z), {
                    variant: "ghost",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$o), { class: "size-8 overflow-hidden rounded-full" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$n), { class: "rounded-lg bg-neutral-200 font-semibold text-black dark:bg-neutral-700 dark:text-white" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              return [
                                user.value.avatar ? (openBlock(), createBlock(unref(_sfc_main$m), {
                                  key: 0,
                                  src: user.value.avatar,
                                  alt: user.value.name
                                }, null, 8, ["src", "alt"])) : createCommentVNode("", true),
                                createVNode(unref(_sfc_main$n), { class: "rounded-lg bg-neutral-200 font-semibold text-black dark:bg-neutral-700 dark:text-white" }, {
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(unref(getInitials)(user.value.name)), 1)
                                  ]),
                                  _: 1
                        ...
                        return [
                          createVNode(unref(_sfc_main$o), { class: "size-8 overflow-hidden rounded-full" }, {
                            default: withCtx(() => [
                              user.value.avatar ? (openBlock(), createBlock(unref(_sfc_main$m), {
                                key: 0,
                                src: user.value.avatar,
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$j), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$d, { user: user.value }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_sfc_main$d, { user: user.value }, null, 8, ["user"])
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(unref(_sfc_main$e), { "as-child": true }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$z), {
                    variant: "ghost",
                    size: "icon",
      ...
      if (props.breadcrumbs.length > 1) {
        ...
        _push(ssrRenderComponent(_sfc_main$p, { breadcrumbs: __props.breadcrumbs }, null, _parent));
        _push(`</div></div>`);
      } else {
        _push(`<!---->`);
      }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.variant === "header") {
        ...
        _push(ssrRenderComponent(unref(_sfc_main$A), mergeProps({ "default-open": unref(isOpen) }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            } else {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$7, mergeProps({ class: "flex-col" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$8, { breadcrumbs: __props.breadcrumbs }, null, _parent2, _scopeId));
            ...
            return [
              createVNode(_sfc_main$8, { breadcrumbs: __props.breadcrumbs }, null, 8, ["breadcrumbs"]),
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$6, mergeProps({ breadcrumbs: __props.breadcrumbs }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
          } else {
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, { breadcrumbs: unref(breadcrumbs) }, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(mergeProps({
        class: unref(cn)("flex flex-col gap-6")
      }, _attrs))}><div class="flex flex-col items-center gap-2 text-center"><h1 class="text-2xl font-bold"> Login to your account </h1><p class="text-balance text-sm text-muted-foreground"> Enter your email below to login to your account </p></div><div class="grid gap-6"><div class="grid gap-2">`);
      _push(ssrRenderComponent(unref(_sfc_main$3), { for: "email" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Email`);
          } else {
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/LoginForm.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid min-h-svh lg:grid-cols-2" }, _attrs))}><div class="flex flex-col gap-4 p-6 md:p-10"><div class="flex justify-center gap-2 md:justify-start"><a href="#" class="flex items-center gap-2 font-medium"> The Hub </a></div><div class="flex flex-1 items-center justify-center"><div class="w-full max-w-xs">`);
      _push(ssrRenderComponent(_sfc_main$2, null, null, _parent));
      _push(`</div></div></div><div class="relative hidden bg-muted lg:block"><img src="https://www.shadcn-vue.com/placeholder.svg" alt="Image" class="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale"></div></div>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/layouts/auth/Layout.vue");
