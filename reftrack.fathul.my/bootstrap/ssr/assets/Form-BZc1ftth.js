...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative overflow-hidden bg-gradient-to-br from-red-900 via-red-800 to-red-900 text-white" }, _attrs))} data-v-a9c32952><div class="absolute inset-0 opacity-10" data-v-a9c32952><div class="absolute inset-0 bg-dot-pattern animate-pulse" data-v-a9c32952></div></div><div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24" data-v-a9c32952><div class="text-center" data-v-a9c32952><div class="mb-8 animate-fade-in-up" data-v-a9c32952><img src="https://cdn.fathul.my/assets/logo/ypadvancedskills-logo-whiteondark.svg" alt="YPAdvancedSkills Logo" class="h-16 mx-auto" data-v-a9c32952></div><h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in-up animation-delay-200" data-v-a9c32952><span class="block text-white" data-v-a9c32952>Program</span><span class="block bg-gradient-to-r from-amber-300 via-yellow-300 to-amber-300 bg-clip-text text-transparent animate-gradient-x" data-v-a9c32952> Jaminan Kerjaya </span><span class="block text-white" data-v-a9c32952>2025</span></h1><div class="animate-fade-in-up animation-delay-400" data-v-a9c32952><p class="text-lg text-white/90 flex items-center justify-center space-x-2" data-v-a9c32952><span data-v-a9c32952>A collaboration and education product of </span><img src="https://cdn.fathul.my/assets/logo/nematix-logo-fullcolor.svg" alt="Nematix Logo" class="h-6 mb-2 ml-1" data-v-a9c32952></p></div></div></div></div>`);
}
...
const ProgramHeader = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a9c32952"]]);
const _sfc_main$i = {
