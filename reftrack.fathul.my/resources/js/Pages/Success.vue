      ...
      <div class="text-center">
        ...
        <div class="bg-card border border-border rounded-lg p-6 mb-8 text-left">
          ...
          <ul class="space-y-3 text-muted-foreground">
            <li class="flex items-start">
              ...
              <span>Pasukan kami akan meneliti permohonan anda.</span>
            </li>
            <li class="flex items-start">
              <span class="flex-shrink-0 w-2 h-2 bg-[#941e20] rounded-full mt-2 mr-3"></span>
        ...
        <div class="space-y-4">
          ...
          <p class="text-sm text-muted-foreground">
            Sebarang pertanyaan? Hubungi saya di 
            <a href="https://wa.me/60111205317" target="_blank" class="text-[#941e20] hover:underline inline-flex items-center">
